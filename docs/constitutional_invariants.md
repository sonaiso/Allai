...
The closure record must certify closure of mandatory rank gates:
- existence
- designation
- possibility
- identity
...
Trace-chain validity requires required constitutional events to appear in constitutional order (no-jump sequencing).
...
## Non-negotiable rule 4 (minimum-first doctrine)
